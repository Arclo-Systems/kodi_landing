  ...
  (
    ...
    const screenContent = isScrollable ? (
      <ReactLenis
        ...
        className={cn('absolute inset-[1.9rem] overflow-y-auto scrollbar-hide rounded-[5rem]')}
      >
        {children ? (
          children
        ) : (
    ...
    return (
      <div ref={ref} className={cn('relative inline-block', className)} style={scaleStyle}>
        <motion.div
          ref={deviceRef}
